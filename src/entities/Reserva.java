...
public Reserva(Integer numeroDoQuarto, Date entrada, Date saida)throws DomainException {
    if (!saida.after(entrada)) {
        throw new DomainException("Erro na reserva: saida tem que ser posterior a entrada.");
    }
